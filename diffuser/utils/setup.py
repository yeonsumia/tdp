...
class Parser(Tap):
    ...
    def generate_exp_name(self, args):
        ...
        if callable(exp_name):
            ...
            if args.use_tree:
                exp_name_string += f'_multi{args.multi_task}_tree_lambda{args.tree_lambda}_th{args.one_minus_alpha}'
            elif args.use_original_tree:
                exp_name_string += f'_multi{args.multi_task}_original_tree_lambda{args.tree_lambda}_th{args.one_minus_alpha}'

            else:
                exp_name_string += f'_multi{args.multi_task}_vanilla'
